// ignore_for_file: prefer_if_null_operators, use_build_context_synchronously, unused_local_variable, non_constant_identifier_names, avoid_print, depend_on_referenced_packages
...
/*
  static numberFormatter<String>(dynamic number, {dynamic format = '#,##0'}) {
    return NumberFormat(format).format(number);
  }
  */

  static String decimalConverter(double number) {
    var numb = int.parse(number.toString().split('.').last);
    String result;
